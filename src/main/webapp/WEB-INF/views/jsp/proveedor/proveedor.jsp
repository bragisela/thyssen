                    ...
                    <div class="card">
                        <div class="card-header">
                            <ol class="breadcrumb mb-1 mt-1">
                                ...
                                <li class="breadcrumb-item active">${titleProveedor}</li>
                            </ol>
                        </div>
                        <div class="card-body">
                            <div class="container">

                                <form:form class="form-horizontal" method="post" action="/thyssenplastic/proveedor/addOrEditOrRemove" modelAttribute="proveedorForm" id="myForm">
                                    ...
                                    <div class="form-row row">
                                        <div class="row col-xs-9 col-sm-3 col-xl-4">
                                            ...
                                            <a href="/thyssenplastic/proveedor"><button type="button" class="btn btn-secondary">Cancelar</button></a>
                                        </div>
                                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row col-xs-12 col-sm-12 col-xl-12">
                        <table id="proveedoresTable" class="display table table-striped table-hover cell-border">
                            <thead>
                                <tr>
                                    <th>CODIGO</th>
                            ...
                            <tbody>
                                ...
                                <c:forEach  items="${proveedores}" var="proveedor">
                                    <tr>
                                        ...
                                        <td class="hidden-xs hidden-sm"><c:out value="${proveedor.cuit}" /></td>
                                        <td><c:out value="${proveedor.razonSocial}" /></td>
                                        <td class="hidden-xs hidden-sm"><c:out value="${proveedor.telefono}" /></td>
                                        <td class="hidden-xs hidden-sm"><c:out value="${proveedor.mail}" /></td>
                                        <td>                                                    
                                            <a class="nav-link active fa fa-pencil-square-o fa-lg" href="/thyssenplastic/proveedor/edit/${proveedor.pk}" data-toggle="tooltip" data-placement="top" title="Editar"></a>
                                            <a class="nav-link active fa fa-trash fa-lg" href="/thyssenplastic/proveedor/remove/${proveedor.pk}" data-toggle="tooltip" data-placement="top" title="Eliminar"></a>
                                            <a class="nav-link active fa fa-users fa-lg" href="/thyssenplastic/contacto/proveedorpk/${proveedor.pk}" data-toggle="tooltip" data-placement="top" title="Contactos"></a>
                                            <a class="nav-link active fa fa-building fa-lg" href="/thyssenplastic/domicilio/proveedorpk/${proveedor.pk}" data-toggle="tooltip" data-placement="top" title="Domicilios"></a>
                                        </td>                                    
                                    </tr>
                                </c:forEach>                                        
                            </tbody>
