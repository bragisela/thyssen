 ...
 * @author gusta
 */
public class GraficoBobinaDetalleForm {
    ...
    private String idGraficoBobina;
    ...
    public String getIdGraficoBobina() {
        return idGraficoBobina;
    }

    public void setIdGraficoBobina(String idGraficoBobina) {
