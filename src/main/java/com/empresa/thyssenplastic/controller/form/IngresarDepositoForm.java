...
public class IngresarDepositoForm {
    ...
    private String pkEditar;
    private String idBultoEditar;
    ...
    public String getPkEditar() {
        return pkEditar;
    }

    public void setPkEditar(String pkEditar) {
        this.pkEditar = pkEditar;
    }

    public String getIdBultoEditar() {
        return idBultoEditar;
    }

    public void setIdBultoEditar(String idBultoEditar) {
        this.idBultoEditar = idBultoEditar;
    }
