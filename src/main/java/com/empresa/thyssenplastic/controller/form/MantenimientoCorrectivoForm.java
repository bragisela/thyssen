 ...
 * @author gusta
 */
public class MantenimientoCorrectivoForm {
    ...
    public String getIdUserAlta() {
        return idUserAlta;
    }

    public void setIdUserAlta(String idUserAlta) {
        this.idUserAlta = idUserAlta;
    }

    public String getIdUserFin() {
        return idUserFin;
    }

    public void setIdUserFin(String idUserFin) {
